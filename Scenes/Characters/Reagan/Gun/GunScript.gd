...
var BulletCasingParticle = preload("res://Scenes/Characters/Reagan/Particles/BulletCasingParticle.tscn")

var BulletExplosionParticle = preload("res://Scenes/Characters/Reagan/Particles/BulletParticle.tscn")
